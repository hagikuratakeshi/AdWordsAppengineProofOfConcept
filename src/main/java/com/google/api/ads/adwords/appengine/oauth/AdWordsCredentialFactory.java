...
package com.google.api.ads.adwords.appengine.oauth;
 ...
 */
public class AdWordsCredentialFactory {
  ...
  @Inject
  public AdWordsCredentialFactory(CredentialStore credentialStore, HttpTransport httpTransport,
      JsonFactory jsonFactory, @Named("clientId") String clientId,
      @Named("clientSecret") String clientSecret, @Named("developerToken") String developerToken,
